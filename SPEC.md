...
| `$80-$BF` | UCI-family backends — the existing `UCI_ERR_*` values (`$81-$8A`) are grandfathered unchanged; `$8B` is the first code allocated under the table rule |
